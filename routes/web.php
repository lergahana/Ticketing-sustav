...
Route::group(['middleware' => 'agent'], function () {
    ...
    Route::middleware(['auth:sanctum', 'verified'])->delete('/obrisi_ticket/{id}', 'App\Http\Controllers\TicketsController@destroy')->name('obrisi_ticket');
...
Route::group(['middleware' => 'technician'], function () {
    ...
    Route::middleware(['auth:sanctum', 'verified'])->post('tech/zatvori_ticket/{id}', 'App\Http\Controllers\TechniciansController@solve')->name('tech/zatvori_ticket');
});
